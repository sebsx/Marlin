 ...
 */
#define LIN_ADVANCE //sebs
#if ENABLED(LIN_ADVANCE)
//#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
#define LIN_ADVANCE_K 0.13 // sebs    // Unit: mm compression per 1mm/s extruder speed
 ...
 */
#define ADVANCED_PAUSE_FEATURE // sebs
